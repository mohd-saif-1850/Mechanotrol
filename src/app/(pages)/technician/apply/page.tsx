    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-gray-100 to-orange-50 relative overflow-hidden">
      ...
      <div className="backdrop-blur-xl bg-white/70 border border-white/40 shadow-[0_8px_40px_rgba(0,0,0,0.1)] px-12 py-16 rounded-3xl text-center max-w-xl mx-auto">
        ...
        <h1 className="mt-2 text-5xl font-extrabold tracking-tight bg-gradient-to-r from-[#FF3B30] via-[#FF6A00] to-[#FF8C00] text-transparent bg-clip-text">
          Technician & Mechanical Apply System
        </h1>

        <p className="mt-5 text-lg text-gray-600">
          A dedicated system for technicians and mechanical specialists to apply, submit requests, and get approved.
        </p>

        <p className="mt-1 text-gray-500">
          We’re building something powerful. Stay tuned — launching soon.
        </p>

        <div className="mt-10 flex gap-5 justify-center">
          <button className="px-6 py-3 rounded-xl font-semibold bg-gradient-to-r from-[#FF3B30] to-[#FF6A00] text-white shadow-lg hover:scale-105 transition">
            Apply as Technician
          </button>

          <button className="px-6 py-3 rounded-xl font-semibold border border-gray-300 text-gray-700 hover:bg-gray-100 transition">
            Apply as Mechanical
          </button>
        </div>
